...
public class EventDto implements Serializable{
	...
	public EventDto(Long idArtist, Long idEvent, String artistName, String artistLastName, String artistMail,
	...
	public String toString() {
		return "EventDto [idArtist=" + idArtist + ", idEvent=" + idEvent + ", artistName=" + artistName
				...
				+ Arrays.toString(artistPhoto) + ", typeEventDto=" + typeEventDto + ", descriptionDto=" + descriptionDto
				+ ", eventPhoto=" + Arrays.toString(eventPhoto) + ", shared=" + shared + ", idOwnerDto=" + idOwnerDto
